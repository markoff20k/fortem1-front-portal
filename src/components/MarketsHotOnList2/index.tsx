...
export const MarketsHotOnlist2: React.FC<any> = () => {
	const defaultTicker = {
		amount: '0.0',
		last: '0.0',
		high: '0.0',
					...
					<div className="row mt-3" style={{ zIndex: 999, position: 'relative' }}>
						<div className="col-12 d-flex justify-content: center">
							<div>
								...
								<span className="ml-2" style={{ marginRight: '5px', color: '#f5f5f5', fontWeight: 'bold' }}>
									{volume}
								</span>
								<span style={{ color: '#f5f5f5' }}>{quoteCurrency}</span>
							</div>
						</div>
					</div>

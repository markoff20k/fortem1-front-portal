...
export const IEOItem: React.FC<SaleItemProps> = (props: SaleItemProps) => {
    ...
    return (
        <div className="sale-item" onClick={handleDetailClick}>
            <span className="sale-item__badge" style={{ backgroundColor: saleBadgeColor }}>{saleType}</span>
            <div className="row">
                <div className="col-6">
            ...
            <div className="row">
                <div className="col-12 text-center" style={{ padding: '0 5rem' }}>
                    ...
                    <Progress strokeColor={{
                        '0%': '#2a9d8f',
                        '100%': '#e76f51',
                    }} status="active" percent={Math.floor((props.sale.total_ieo - props.sale.remains) / props.sale.total_ieo * 100)}/>
                </div>
            </div>
            <hr />
            <div className="row">
                ...
                <div className="col-6 d-flex align-items-center justify-content-center">
                    <Row gutter={[8, 8]}>
                        {props.sale.currency_available.map((currency) => (
                            <Col span={8}>
                                <img style={{ width: '3rem', height: '3rem', marginLeft: '1rem', marginTop: '1rem' }} src={findIcon(currency)} alt="" />
                            </Col>
                        ))}
                    </Row>

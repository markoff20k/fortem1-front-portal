...
import { ConvertUsd, Decimal, ButtonFIAT, FiatMarketFill } from '../../components';

import { MarketsHotOnlist2 } from 'src/components/MarketsHotOnList2';
import { UdonMarketTable } from 'src/components/UdonMarketTable';

import Tabs, { TabPane } from 'rc-tabs';

import { useMarketsFetch, useMarketsTickersFetch, useRangerConnectFetch } from 'src/hooks';
...
export const MarketsListExchange = props => {
	...
	const formattedMarkets = currentBidUnitMarkets.length
		? currentBidUnitMarkets
				...
				.map(market => {
					const marketChangeColor = +(market.change || 0) < 0 ? '#ED0A3F' : '#00CC99';
	...
	const MarketsTabs = () => {
		return (
			<div className="cx-market-item w-container">
...
export const MarketsTableScreen = React.memo(MarketsListExchange);

...
export const HomepageMarket = props => {
	...
	const findIcon = (code: string): string => {
		...
		try {
			return require(`../../assets/images/cryptocurrency-icons/128/color/${code.toLowerCase()}.png`).default;
		} catch (err) {
			if (currency) {
				return currency.icon_url;
			}

			return require('../../assets/images/cryptocurrency-icons/svg/color/generic.svg').default;
		}
	};

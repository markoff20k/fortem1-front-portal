...
class SidebarContainer extends React.Component<Props, State> {
    ...
    public render() {
        ...
        const sidebarClassName = classnames('pg-sidebar-wrapper', {
            ...
            'pg-sidebar-wrapper--hidden pg-sidebar-wrapper-nav-item-text-disabled': !isActive,
            
        });

        // if (isLoggedIn) (this.props.toggleSidebar(false));
        ...
        return (
            <aside className={sidebarClassName}>
                <div
                    ...
                    <span className="pg-sidebar__toggler-item" />
                    <span className="pg-sidebar__toggler-item" /> */}
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true" color="var(--primary-text-color)" height="20" width="20" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
                </div>
                    ...
                    {/* <Link to="/profile" onClick={handleLinkChange} className={`${isActive && 'route-selected'}`}> */}
                        <div className="pg-sidebar-wrapper-profile-area">
                            ...
                            <p className="pg-sidebar-wrapper-profile-area-text-account">
                                {/* <FormattedMessage id={'page.header.navbar.profile'} /> */}
                                <FormattedMessage id={'page.header.navbar.account'} /> <span className='pg-sidebar-wrapper-profile-area-text-fid'>{this.props.user.uid}</span>
                            </p>

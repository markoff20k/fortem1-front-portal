...
import fortemIcon from './fortemIcon.png';
...
export const Footer: React.FC = Props => {
	...
	return <React.Fragment>{renderFooterDesktop(inputEmail, sendEmail, emailAddress, handleScrollTop)}</React.Fragment>;
};

const renderFooterDesktop = (inputEmail, sendEmail, emailAddress, handleScrollTop) => {

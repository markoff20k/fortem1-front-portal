  ...
  return (
    <div className="modal">
      <div className="modal-header">
        ...
        >
          <svg width="40" height="40" viewBox="0 0 14 14" className="close-icon" fill="#000">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.58434 6.99901L0.875873 11.7079L2.29003 13.1221L6.99849 8.41328L11.707 13.1221L13.1211 11.7079L8.41265 6.99901L13.704 1.7072L12.2899 0.292927L6.99849 5.58474L1.70712 0.292932L0.292969 1.7072L5.58434 6.99901Z" fill="var(--icons)">
            </path>
        </svg>
...
<div className="inset-x-0 top-0 -z-10 bg-white">
    ...
    <div className="flex flex-wrap w-full">
        ...
        <div className="flex flex-col flex-wrap w-full md:w-6/12 gap-x-6 gap-y-1 p-4 bg-red-5000">

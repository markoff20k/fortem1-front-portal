<script>
    ...
    import { toogleMenuNavItemTech } from '$lib/stores/menuActiveItem';
...
<div class="relative isolate z-30 shadow">
    ...
    <div class="flex flex-wrap p-2 justify-end w-100">
        <button id=""
        on:click={() => toogleMenuNavItemTech()} class="flex-none rounded-full bg-slate-500 py-1 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">
  ...
  <div class="absolute inset-x-0 top-0 -z-10 bg-white pt-4 shadow-lg ring-1 ring-gray-900/5">
    <div class="mx-auto grid max-w-7xl grid-cols-1 gap-y-10 gap-x-8 py-10 px-6 lg:grid-cols-2 lg:px-8">
      ...
      <div class="grid grid-cols-2 gap-x-6 sm:gap-x-8">
        <div>
          <h3 class="text-sm font-medium leading-6 text-gray-500">Engagement - Tech  </h3>
        ...
        <article class="relative isolate flex max-w-2xl flex-col gap-x-8 gap-y-6 sm:flex-row sm:items-start lg:flex-col lg:items-stretch">
          ...
          <div>
            <div class="flex items-center gap-x-4">
              ...
              <a href="#" class="relative z-10 rounded-full bg-gray-50 py-1.5 px-3 text-xs font-medium text-gray-600 hover:bg-gray-100">Marketing</a>
            </div>
        ...
        <article class="relative isolate flex max-w-2xl flex-col gap-x-8 gap-y-6 sm:flex-row sm:items-start lg:flex-col lg:items-stretch">
          ...
          <div>
            <div class="flex items-center gap-x-4">
              ...
              <a href="#" class="relative z-10 rounded-full bg-gray-50 py-1.5 px-3 text-xs font-medium text-gray-600 hover:bg-gray-100">Sales</a>
            </div>
            <h4 class="mt-2 text-sm font-semibold leading-6 text-gray-900">
              <a href="#">
                <span class="absolute inset-0"></span>

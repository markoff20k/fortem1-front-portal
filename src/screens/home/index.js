...
export function Home(props) {
  ...
  return (
    <Container>
      <Content style={!props.isOpened ? { width: "calc(100% - 120px)" } : {}}>
        ...
        <Tokens>
          <div className="highlights">
            <h3 style={props.themeDark ? { color: "#fff" } : { color: "#000" }}>
              Tokens em destaques
            </h3>
            <button
              style={props.themeDark ? { color: "#fff" } : { color: "#000" }}
          ...
          <Tables>
            <div className="div-cripto">
              ...
              <div>
                <button
                  style={
                    props.themeDark ? { color: "#fff" } : { color: "#000" }
                  }
                >
                  Cripto
                </button>

...
class Landing extends React.Component<Props> {
    ...
    public render() {
        ...
        return (
            <div className="pg-landing-screenMobile">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-16 sm:pt-16 lg:px-8 lg:pt-24">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="title font-bold tracking-tight text-fortem1neutral-300">FORTEM ONE É A PLATAFORMA ESPECIALIZADA EM...</h1>
                  <h1>
                        <Typed
                                strings={[
                                    "ativos digitais",
                ...
                <div className="mt-14 flex justify-start gap-6 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                  ...
                  <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                    <div className="relative">
                      <img src="https://storage.googleapis.com/public_fortem/Come%20Together.gif" alt="" className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg" />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10"></div>
                    </div>
                    <div className="relative">
                      <img src="https://storage.googleapis.com/public_fortem/download%20(4).jpeg" alt="" className="aspect-[2/3] rounded-xl bg-gray-900/5 object-cover shadow-lg" />
                ...
                <div className='fortem-landing-hero'>
                    <p className="relative text-fortem1neutral-300">Dos investimentos em tokens à conta digital.</p>
                    <p className="relative text-fortem1neutral-300">Aqui você tem o controle integrado de todas as suas necessidades financeiras.</p>
                </div>

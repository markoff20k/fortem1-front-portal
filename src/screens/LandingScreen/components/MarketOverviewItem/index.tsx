...
import { CurrencyIcon2 } from 'components/CurrencyIcon';
...
export const MarketOverviewItem = (props: MarketOverviewItemProps) => {
	...
	return (
		<React.Fragment>
			...
			>
				<td>
					<CurrencyIcon2 currency_id={props.baseCurrency} className="item-icon" />
					{props.baseCurrency}
				</td>
								...
								<thead>
									<tr>
										...
										*/}
										...
										<th>Último preço</th>
										<th>Variação 24h</th>
										<th>Menor Preço 24h</th>
										<th>Maior preço 24h</th>
										<th>Volume 24h</th>
										<th>Valor 24h</th>
										<th></th>
									</tr>

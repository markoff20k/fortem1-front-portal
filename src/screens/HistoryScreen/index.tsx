...
import { FilterElement } from 'src/components/FilterElementOrdersHistory';
...
export const HistoryScreen = () => {
	...
	const renderTableRow = (type: string, item, index) => {
		...
		switch (type) {
			case 'deposits': {
				...
				const minConfirmations = itemCurrency && itemCurrency.symbol;
	...
	return (
		<div className="history-screen history-screen-container">
			<div className="history-screen__title">Extrato de operações</div>
			{renderFilterBar()}

          ...
          <div style={{display: 'flex', flexDirection: 'row', marginBottom: '20px', justifyContent: 'space-between'}} >
            <div style={{display: 'flex', flexDirection: 'row', marginBottom: '20px'}} >
              ...
              <div style={{display: 'flex', flexDirection: 'column', marginLeft: '20px', justifyContent: 'space-evenly'}} >
                ...
                <span style={{color: '#22C55E', fontFamily: 'Inter', fontSize: '14px', fontWeight: '400', lineHeight: '16.94px', opacity: '0.84'}}> + 1.52% a.m <span style={{color: 'var(--input-text-color)'}}> | Receba em 1x até 16/04/2024   </span> </span>
              </div>
            </div>

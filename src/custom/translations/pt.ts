...
export const pt: LangType = {
    ...
    'page.body.trade.header.newOrder.locked.minLevel.buttonText': 'Conclusa seu cadastro',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.message.disable': 'Desabilitar',
    ...
    'page.body.profile.content.result.denied': 'Não autorizado',

...
export const pt: LangType = {
    ...
    'page.body.wallets.balance.spot': 'Saldo disponível (SPOT)',
    ...
    'page.body.wallets.tabs.deposit.ccy.blockchain.networks': 'Redes blockchain',
    ...
    'page.body.wallets.overview.header.total': 'Saldo total',

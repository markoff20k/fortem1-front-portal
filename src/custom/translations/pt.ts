...
export const pt: LangType = {
    ...
    'success.documents.accepted': 'Documentos atualizadas com sucesso',
    ...
    'resource.documents.limit_will_be_reached': 'Quantidade máxima de upload de documentos atingida',

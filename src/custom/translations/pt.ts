...
export const pt: LangType = {
    ...
    'page.body.profile.verification.document.rejected.tooltip': 'Documentação não aprovada',
    ...
    'page.body.profile.verification.progress.tooltip.email.rejected': 'Email não confirmado com sucesso',
    ...
    'page.body.profile.verification.progress.tooltip.profile.rejected': 'Informações pessoais não aprovadas',
    'page.body.profile.verification.progress.tooltip.profile.pending': 'Análise das informações de cadastro pode levar até 2h.',
    ...
    'page.body.profile.verification.progress.tooltip.document.rejected': 'Documentos não aprovados',
    'page.body.profile.verification.progress.tooltip.document.pending': 'Análise da sua documentação pode levar até 2h.',
    ...
    'page.body.kyc.documents.idNumber.placeholder': 'Número do documento',
    ...
    'page.body.kyc.documents.uploadFile.front.label': 'Arraste e solte uma cópia legível da frente do seu documento no campo abaixo',
    'page.body.kyc.documents.uploadFile.front.button': 'Anexar',
    'page.body.kyc.documents.uploadFile.front.formats': 'Formatos aceitos: JPG, JPEG, PNG, HEIC ou PDF',
    'page.body.kyc.documents.uploadFile.back.title': 'Verso',
    'page.body.kyc.documents.uploadFile.back.label': 'Arraste e solte uma cópia legível do verso do seu documento no campo abaixo',
    'page.body.kyc.documents.uploadFile.back.button': 'Anexar',
    'page.body.kyc.documents.uploadFile.back.formats': 'Formatos aceitos: JPG, JPEG, PNG, HEIC ou PDF',
    'page.body.kyc.documents.uploadFile.selfie.title': 'Sua selfie',
    'page.body.kyc.documents.uploadFile.selfie.label': 'Anexe uma foto da sua selfie',
    'page.body.kyc.documents.uploadFile.selfie.button': 'Anexar',
    'page.body.kyc.documents.uploadFile.selfie.formats': 'Formatos aceitos: JPG, JPEG, PNG, HEIC ou PDF',
    ...
    'page.footer.legalDocuments': 'Termos e Políticas',
    'page.footer.faq': 'FAQ',
    ...
    'page.body.quick.exchange.confirm': 'Confirmar conversão',

    'page.body.quick.exchange.preview': 'Preview',

    // success messages
    'success.addresses.accepted': 'Endereço de cadastro atualizadas com sucesso',
    'success.documents.accepted': 'Documentos atualizados com sucesso',
    'success.identity.accepted': 'Informações pessoais de cadastro atualizadas com sucesso',
    'success.withdraw.action': 'Solicitação de saque recebida',
    ...
    'success.password.changed.successfuly': 'Senha atualizada com sucesso',
    ...
    'resource.documents.limit_will_be_reached': 'Quantidade máxima de upload de documentos atingida (10)',
    ...
    'resource.password.prev_pass_not_correct': 'Senha anterior incorreta',
    'resource.password.no_change_provided': 'A nova senha deve ser diferente da anterior',
    'resource.document.empty_doc_expire': 'Срок действия недействителен',
    'password.requirements': 'A senha não atende aos requisitos mínimos de segurança',
    'password.password.password_strength': 'Sua senha deve atender aos requisitos mínimos de segurança',
    ...
    'page.header.signUp.fullname': 'Qual seu nome completo?',
